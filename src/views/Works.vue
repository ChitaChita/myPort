...
<v-container fluid>
  <v-layout text-center wrap>
    <v-flex mb-4 xs12>
      ...
      <h3 class="headline font-weight-bold mb-3">制作物一覧</h3>
    </v-flex>
    <v-spacer />
    <v-flex>
